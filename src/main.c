...
int main(int argc, const char **argv)
{
    ...
    hook_error_t err;
    err = hook_Install(0x000900, &parse_hook, 0, HOOK_TYPE_PARSER, 5, "Unit manipulation hook");
    dbg_printf("Err %u installing hook at %p\n", err, &parse_hook);
    err = hook_Install(0x000901, &hs_hook, 0, HOOK_TYPE_HOMESCREEN, 5, "Unit manipulation hook");
    dbg_printf("Err %u installing hook at %p\n", err, &hs_hook);
    hook_Sync();
