...
int main(int argc, const char **argv)
{
    ...
    ti_SetVar(OS_TYPE_CPLX, OS_VAR_M, data_meter);
    ti_SetVar(OS_TYPE_CPLX, OS_VAR_G, data_gram);
    ti_SetVar(OS_TYPE_CPLX, OS_VAR_S, data_second);
    ti_SetVar(OS_TYPE_CPLX, OS_VAR_A, data_ampere);
    ti_SetVar(OS_TYPE_CPLX, OS_VAR_K, data_kelvin);
